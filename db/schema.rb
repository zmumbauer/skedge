...
ActiveRecord::Schema.define(version: 2019_12_16_234402) do
  ...
  create_table "organization_tokens", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["organization_id"], name: "index_organization_tokens_on_organization_id"
  end
  ...
  create_table "swap_requests", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "organization_id"
    t.index ["organization_id"], name: "index_swap_requests_on_organization_id"
  end
